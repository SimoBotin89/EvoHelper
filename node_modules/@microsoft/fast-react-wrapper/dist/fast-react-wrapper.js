...
const emptyProps = Object.freeze(Object.create(null)); // There are 2 kinds of refs and there's no built in React API to set one.
...
function provideReactWrapper(React, designSystem) {
  ...
  function wrap(type, config = {}) {
    ...
    return React.forwardRef((props, ref) => React.createElement(ReactComponent, Object.assign(Object.assign({}, props), {
      __forwardedRef: ref
