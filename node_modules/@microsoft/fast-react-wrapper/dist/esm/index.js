...
export function provideReactWrapper(React, designSystem) {
    ...
    function wrap(type, config = {}) {
        ...
        return React.forwardRef((props, ref) => React.createElement(ReactComponent, Object.assign(Object.assign({}, props), { __forwardedRef: ref }), props === null || props === void 0 ? void 0 : props.children));
    }
